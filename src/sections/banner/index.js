...
const Banner = () => {
    return (
        <section id="banner" className="chineseBlackBg h-screen xl:h-screen">
            <Nav />
            <div class="flex flex-col items-center lg:flex-row xl:flex-row xl:ml-[5%] py-10">
                <div class="text-center md:text-center lg:text-left lg:w-1/2 xl:w-1/2 lg:pl-10 xl:pl-10">
                    <h1 class="text-2xl White lg:text-3xl xl:text-5xl pb-4 font-semibold lg:leading-[3rem] xl:leading-[3.5rem]">Transform your online image<br class="hidden md:inline" /> with a professional website</h1>
                ...
                <img class="max-w-[60%] lg:w-[50%] xl:w-[35%] md:w-[50%] mt-5" src="/media/illustrator/laptop and charts (2).svg" alt="" />
            </div>
        </section>
