  ...
  return (
    <footer className="fixed bottom-0 w-full" id="footer">
      ...
      <div className="relative">
        ...
        <img className="hidden xl:block xl:absolute xl:bottom-[-4rem] xl:right-[11%] z-0 " src="/media/illustrator/Iphone.svg" alt="" />
        <div className="absolute bottom-0 z-40 border-t-[1px] w-full border-White flex px-[10%] xl:gap-[3rem]  font-semibold py-[10px] BlueGreen">
